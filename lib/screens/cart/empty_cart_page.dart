...
import 'package:shop_app/screens/cart/page_switcher.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(color: Color(0xFF0A0E2F).withOpacity(0.8)),
            ...
            ElevatedButton(
              ...
              child: Text(
                'Start Shopping',
                style: TextStyle(
                    fontWeight: FontWeight.w600, color: Color(0xFF0A0E2F)),
              ),
              style: ElevatedButton.styleFrom(
                foregroundColor: Color(0xFF242476),
                padding: EdgeInsets.symmetric(horizontal: 32, vertical: 16),
                backgroundColor: Color(0xFFD3D3E4),
                elevation: 0,
