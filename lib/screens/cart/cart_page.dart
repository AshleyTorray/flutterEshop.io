...
import 'package:shop_app/shop/components/CartService.dart';
...
class _CartPageState extends State<CartPage> {
  ...
  Color primary = Color(0xFF242476);
  Color primarySoft = Color(0xFFEAEAF2);
  Color secondary = Color(0xFF0A0E2F);
  Color border = Color(0xFFD3D3E4);
  @override
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(
            border:
                Border(top: BorderSide(color: Color(0xFFD3D3E4), width: 1))),
